...
function About.InitPanel(opts)
    ...
    panel.sourceCards = {
        ...
        sourceCard("wowhead", L["about.source_role.wowhead"], function()
            local class, spec = classSpec(); return ns.SourceUrls.wowheadGear(class, spec) or ns.SOURCES.wowhead.homepage
        end),
        sourceCard("archongg", L["about.source_role.archongg"], function()
            local class, spec = classSpec(); return ns.SourceUrls.archonGear(class, spec) or ns.SOURCES.archongg.homepage
        end),
    }
