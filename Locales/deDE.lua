...
L["empty.no_spec"] = "Wähle eine Spezialisierung, um dein Bread Codex anzuzeigen."
...
L["settings.tooltip.login_message"] =
    "Gibt beim Anmelden oder UI-Neuladen die Nachricht 'Bread Codex geladen. Tippe /cc zum Öffnen' im Chat aus."
...
L["chat.slash_conflict"] =
    "Ein anderes Addon verwendet |cff00ccff/cc|r. Tippe |cff00ccff/classcodex|r, um Bread Codex zu öffnen."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r Der gerade gesehene '%s'-Fehler ist ein bekannter Blizzard-Fehler. Bread Codex hat ihn nicht verursacht. Deaktiviere 'Talente anzeigen im Rechtsklick-Einheitenmenü hinzufügen' in den Einstellungen, um ihn zu stoppen."
...
L["about.support_iv_tip"] = "Unterstütze Bread Codex mit Icy Veins Premium."
...
L["settings.tooltip.advanced"] = "Öffnet das vollständige Optionsfenster von Bread Codex."
...
L["settings.tooltip.dock_theme"] =
    "Bread Codex fügt einen Farbverlauf-Hintergrund, einen Rahmen und umrandete Symbole hinzu. Kompakt entfernt Hintergrund und Rahmen. Minimalistisch zeigt nur die Beschriftung."
...
L["item.menu.ah_listed"] = 'Zu deiner Auctionator-Einkaufsliste "Bread Codex" hinzugefügt.'
...
L["talent_apply.no_slots_use"] = "Keine freien Vorlagen-Slots. Lösche einen, um Bread Codex-Builds zu verwenden."
...
L["talent_apply.unsaved_changes"] =
    "Du hast nicht gespeicherte Talentänderungen. Öffne das Talentpanel und klicke auf Änderungen anwenden (oder rechtsklicke auf den Vorlagennamen zum Verwerfen), bevor du einen Bread Codex-Build anwendest."
L["talent_apply.could_not_load"] =
    "Die Bread Codex-Vorlage konnte nicht geladen werden. Öffne das Talentpanel, klicke auf Änderungen anwenden und versuche es erneut."
L["talent_apply.name_required"] = "Ein Vorlagenname ist erforderlich."
L["talent_apply.name_reserved"] = '"%s" ist für Bread Codex reserviert. Wähle einen anderen Namen.'
