...
L["empty.no_spec"] = "Choisissez une spécialisation pour afficher votre Bread Codex."
...
L["settings.tooltip.panel_width"] = "Largeur du panneau Bread Codex en pixels. S'applique aux modes ancré et flottant."
...
L["settings.tooltip.login_message"] =
    "Affiche le message « Bread Codex chargé. Tapez /cc pour ouvrir » dans le chat lors de la connexion ou du rechargement."
...
L["chat.slash_conflict"] =
    "Un autre addon utilise |cff00ccff/cc|r. Tapez |cff00ccff/classcodex|r pour ouvrir Bread Codex."
...
L["settings.tooltip.show_loadout_dock"] =
    "Widget flottant affichant le nom de la configuration de talents active. Cliquez pour passer à une configuration Blizzard enregistrée ou une recommandation Bread Codex."
...
L["settings.label.talent_pane_show"] = "Afficher Bread Codex dans le panneau de talents"
L["settings.tooltip.talent_pane_show"] =
    "Affiche le sélecteur de build Bread Codex dans le panneau de talents Blizzard. Désactivez pour le masquer complètement."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r L'erreur « %s » que vous venez de voir est un bug Blizzard connu. Bread Codex n'en est pas la cause. Désactivez « Ajouter Voir les talents au menu clic droit des unités » dans les paramètres pour l'arrêter."
...
L["about.discord"] = "Discord Bread Codex"
...
L["about.settings_tip"] = "Ouvre toutes les options de Bread Codex."
L["about.discord_tip"] = "Bugs, retours et theorycrafting."
L["about.support_iv_tip"] = "Soutenez Bread Codex en passant Premium sur Icy Veins."
...
L["settings.tooltip.advanced"] = "Ouvre la fenêtre complète des options de Bread Codex."
...
L["settings.tooltip.dock_background"] =
    "Couleur d'arrière-plan du dock à pleine opacité. Utilisez la couleur de votre classe ou une couleur personnalisée. Thème Bread Codex uniquement."
...
L["settings.tooltip.dock_theme"] =
    "Bread Codex ajoute un arrière-plan en dégradé, une bordure et des icônes cerclées. Compact supprime l'arrière-plan et la bordure. Minimaliste affiche uniquement l'étiquette."
...
L["item.menu.ah_listed"] = 'Ajouté à votre liste de courses Auctionator "Bread Codex".'
...
L["onboarding.title"] = "Visite de Bread Codex"
L["onboarding.next"] = "Suivant"
L["onboarding.help_tooltip_title"] = "Visite de Bread Codex"
...
L["onboarding.talent_body"] =
    "Bread Codex ajoute un sélecteur de build à votre arbre de talents. Choisissez un build et les talents modifiés s'illuminent.\n\n|cffffd100Cliquez sur l'icône pour l'afficher ou la masquer.|r"
L["onboarding.thanks_title"] = "Tout est prêt"
L["onboarding.thanks_body"] =
    "Merci d'utiliser |cffffd100Bread Codex|r.\n\nQuestions, bugs ou idées ?\nRejoignez-nous sur Discord."
...
L["talent_apply.no_slots_use"] =
    "Aucun emplacement de configuration libre. Supprimez-en un pour utiliser les builds de Bread Codex."
...
L["talent_apply.unsaved_changes"] =
    "Vous avez des modifications de talents non enregistrées. Ouvrez le panneau de talents et cliquez sur Appliquer les modifications (ou faites un clic droit sur le nom de la configuration pour les abandonner) avant d'appliquer un build de Bread Codex."
L["talent_apply.could_not_load"] =
    "Impossible de charger la configuration de Bread Codex. Ouvrez le panneau de talents, cliquez sur Appliquer les modifications, puis réessayez."
L["talent_apply.name_required"] = "Le nom de la configuration est requis."
L["talent_apply.name_reserved"] = '"%s" est réservé à Bread Codex. Choisissez un autre nom.'
