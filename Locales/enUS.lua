...
L["context.mplus"] = "Mythic+"
L["context.delves"] = "Delves"
L["context.crafting"] = "Crafting"
L["context.overall"] = "Overall"
L["archon.season1_notice"] = "|cffffd100Season 1 data.|r Full encounter information will be available when Season 2 launches."
...
L["consumable.health_potion"] = "Health Potion"
...
-- About panel
L["about.title"] = "About Bread Codex v%s"
...
L["about.source_role.wowhead"] = "Community database"
L["about.source_role.archongg"] = "Top-parse popularity"
L["about.supporters"] = "Supporters"
L["about.support_patreon"] = "Support on Patreon"
L["about.free_message"] = "Bread Codex is free and open to everyone. Supporters on Patreon help keep the data fresh and the project moving forward."
L["about.be_first_supporter"] = "Be the first to support Bread Codex!"
...
L["settings.label.archon_bis"] = "Archon BiS on Tooltips"
L["trinkets.paired_with"] = "with %s"
...
L["settings.tooltip.panel_width"] = "Width of the Bread Codex panel in pixels. Applies to both the docked and floating modes."
...
L["settings.tooltip.archon_bis"] = "Show which specs an item is Best in Slot for (Archon) on item tooltips, with the share of top logs running it."
...
L["settings.tooltip.login_message"] = "Print the 'Bread Codex loaded — type /cc to open' message to chat when you log in or reload."
...
L["chat.slash_conflict"] = "Another addon is using |cff00ccff/cc|r — type |cff00ccff/classcodex|r to open Bread Codex."
...
L["settings.tooltip.source_display"] = "How to display data sources (u.gg, Icy Veins, Wowhead) on item tooltips."
...
L["settings.value.archongg"] = "Archon"
...
L["settings.tooltip.show_loadout_dock"] = "Floating widget that shows the active talent loadout name. Click to switch to any saved Blizzard loadout or Bread Codex recommendation."
...
L["loadout_dock.no_wowhead_builds"] = "No Wowhead talent builds available."
L["loadout_dock.no_archon_builds"] = "No Archon talent builds available."
...
L["settings.label.dock_show_wowhead"] = "Show Wowhead builds in menu"
L["settings.label.dock_show_archon"] = "Show Archon builds in menu"
...
L["settings.tooltip.dock_show_wowhead"] = "Include Wowhead's talent builds, grouped by hero talent, in the dock's click menu."
L["settings.tooltip.dock_show_archon"] = "Include archon.gg's talent builds, grouped by hero talent, in the dock's click menu."
...
L["settings.label.talent_pane_show"] = "Show Bread Codex on talent frame"
L["settings.tooltip.talent_pane_show"] = "Show the Bread Codex build picker on the Blizzard talent frame. Disable to hide it entirely."
...
L["chat.blizzard_bug_notice"] = "|cff66ccff[Bread Codex]|r The '%s' error you just saw is a known Blizzard bug, not a Bread Codex bug. Disable 'Add View Talents to right-click unit menus' in Bread Codex settings to stop it."
...
L["footer.data_refresh_hint"] = "Data refreshes daily. Update Bread Codex to get the latest."
