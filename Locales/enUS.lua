...
L["empty.no_spec"] = "Choose a specialization to view your Bread Codex."
...
L["settings.tooltip.panel_width"] =
    "Width of the Bread Codex panel in pixels. Applies to both the docked and floating modes."
...
L["settings.tooltip.login_message"] =
    "Print the 'Bread Codex loaded. Type /cc to open' message to chat when you log in or reload."
...
L["settings.tooltip.show_loadout_dock"] =
    "Floating widget that shows the active talent loadout name. Click to switch to any saved Blizzard loadout or Bread Codex recommendation."
...
L["settings.tooltip.dock_theme"] =
    "Bread Codex adds a gradient background, border, and ringed icons. Compact drops the background and border. Minimalist shows the label only."
...
L["settings.tooltip.dock_background"] =
    "Dock background color at full opacity. Use your class color or a custom color. Bread Codex theme only."
...
L["settings.tooltip.talent_pane_show"] =
    "Show the Bread Codex build picker on the Blizzard talent frame. Disable to hide it entirely."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r The '%s' error you just saw is a known Blizzard bug. Bread Codex didn't cause it. Disable 'Add View Talents to right-click unit menus' in Bread Codex settings to stop it."
...
L["talent_apply.no_slots_use"] = "No free loadout slots. Delete one to use Bread Codex builds."
...
L["talent_apply.name_reserved"] = '"%s" is reserved for Bread Codex. Pick a different name.'
