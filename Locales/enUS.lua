...
L["chat.slash_conflict"] =
    "Another addon is using |cff00ccff/cc|r — type |cff00ccff/classcodex|r to open Bread Codex."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r The '%s' error you just saw is a known Blizzard bug, not a Bread Codex bug. Disable 'Add View Talents to right-click unit menus' in Bread Codex settings to stop it."
