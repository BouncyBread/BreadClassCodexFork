...
L["chat.slash_conflict"] =
    "다른 애드온이 |cff00ccff/cc|r를 사용 중입니다. |cff00ccff/classcodex|r를 입력해 Bread Codex를 여세요."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r 방금 본 '%s' 오류는 알려진 블리자드 버그입니다. Bread Codex가 유발한 것이 아닙니다. 중지하려면 Bread Codex 설정에서 '유닛 우클릭 메뉴에 특성 보기 추가'를 비활성화하세요."
...
L["about.settings_tip"] = "Bread Codex 전체 옵션을 엽니다."
L["about.discord_tip"] = "버그, 의견, 이론 정립."
L["about.support_iv_tip"] = "Icy Veins에서 Premium을 이용해 Bread Codex를 후원하세요."
...
L["settings.tooltip.advanced"] = "Bread Codex 전체 옵션 창을 엽니다."
...
L["settings.tooltip.dock_background"] =
    "완전 불투명 상태의 도크 배경색입니다. 직업 색상 또는 사용자 지정 색상을 사용하세요. Bread Codex 테마에만 적용됩니다."
...
L["settings.tooltip.dock_theme"] =
    "Bread Codex는 그라디언트 배경, 테두리, 테를 두른 아이콘을 추가합니다. 콤팩트는 배경과 테두리를 제거합니다. 미니멀리스트는 레이블만 표시합니다."
...
L["item.menu.ah_listed"] = 'Auctionator "Bread Codex" 쇼핑 목록에 추가했습니다.'
...
L["onboarding.title"] = "Bread Codex 둘러보기"
L["onboarding.next"] = "다음"
L["onboarding.help_tooltip_title"] = "Bread Codex 둘러보기"
...
L["talent_apply.no_slots_use"] =
    "빈 로드아웃 슬롯이 없습니다. Bread Codex 빌드를 사용하려면 하나를 삭제하세요."
...
L["talent_apply.unsaved_changes"] =
    "저장하지 않은 특성 변경 사항이 있습니다. Bread Codex 빌드를 적용하기 전에 특성 패널을 열고 변경 사항 적용을 클릭하세요(또는 로드아웃 이름을 우클릭해 취소하세요)."
L["talent_apply.could_not_load"] =
    "Bread Codex 로드아웃을 불러올 수 없습니다. 특성 패널을 열고 변경 사항 적용을 클릭한 다음 다시 시도하세요."
L["talent_apply.name_required"] = "로드아웃 이름이 필요합니다."
L["talent_apply.name_reserved"] = '"%s"은(는) Bread Codex 전용입니다. 다른 이름을 선택하세요.'
