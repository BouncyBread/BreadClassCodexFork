...
-- About panel
L["about.title"] = "Bread Codex v%s 정보"
...
L["about.free_message"] = "Bread Codex는 모두에게 무료로 공개되어 있습니다. Patreon 후원자들의 도움으로 데이터를 최신으로 유지하고 프로젝트를 발전시킬 수 있습니다."
L["about.be_first_supporter"] = "Bread Codex의 첫 번째 후원자가 되어 주세요!"
...
L["settings.tooltip.panel_width"] = "Bread Codex 패널의 너비(픽셀). 고정 및 플로팅 모드 모두에 적용됩니다."
...
L["settings.tooltip.login_message"] = "로그인하거나 UI를 다시 불러올 때 'Bread Codex 로드됨 — /cc를 입력하여 열기' 메시지를 채팅에 표시합니다."
...
L["chat.slash_conflict"] = "다른 애드온이 |cff00ccff/cc|r 를 사용 중입니다 — |cff00ccff/classcodex|r 를 입력해 Bread Codex를 여세요."
...
L["settings.tooltip.show_loadout_dock"] = "현재 특성 로드아웃 이름을 표시하는 플로팅 위젯. 클릭하여 저장된 블리자드 로드아웃이나 Bread Codex 추천으로 전환합니다."
...
L["settings.tooltip.talent_pane_show"] = "블리자드 특성 창에 Bread Codex 빌드 선택기를 표시합니다. 끄면 완전히 숨깁니다."
...
L["chat.blizzard_bug_notice"] = "|cff66ccff[Bread Codex]|r 방금 본 '%s' 오류는 알려진 블리자드 버그이며 Bread Codex의 버그가 아닙니다. 중지하려면 Bread Codex 설정에서 '유닛 우클릭 메뉴에 특성 보기 추가'를 비활성화하세요."
...
L["footer.data_refresh_hint"] = "데이터는 매일 갱신됩니다. Bread Codex를 업데이트하여 최신 정보를 받으세요."
L["tab.crafting"] = "제작"
