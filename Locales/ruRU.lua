...
-- About panel
L["about.title"] = "О Bread Codex v%s"
...
L["about.free_message"] = "Bread Codex бесплатен и открыт для всех. Поддержка на Patreon помогает поддерживать данные в актуальном состоянии и развивать проект."
L["about.be_first_supporter"] = "Станьте первым, кто поддержит Bread Codex!"
...
L["settings.tooltip.panel_width"] = "Ширина панели Bread Codex в пикселях. Применяется к закреплённому и плавающему режимам."
...
L["settings.tooltip.login_message"] = "Выводить сообщение 'Bread Codex загружен — введите /cc для открытия' в чат при входе или перезагрузке интерфейса."
...
L["chat.slash_conflict"] = "Другое дополнение использует |cff00ccff/cc|r — введите |cff00ccff/classcodex|r, чтобы открыть Bread Codex."
...
L["settings.tooltip.show_loadout_dock"] = "Плавающий виджет, отображающий название активной раскладки талантов. Нажмите, чтобы переключиться на любую сохранённую раскладку Blizzard или рекомендацию Bread Codex."
...
L["settings.tooltip.talent_pane_show"] = "Показывает выбор билдов Bread Codex в окне талантов Blizzard. Отключите, чтобы полностью скрыть."
...
L["chat.blizzard_bug_notice"] = "|cff66ccff[Bread Codex]|r Ошибка «%s», которую вы только что видели — это известная ошибка Blizzard, а не ошибка Bread Codex. Отключите «Добавить Просмотр талантов в меню правой кнопки мыши» в настройках, чтобы остановить её."
...
L["footer.data_refresh_hint"] = "Данные обновляются ежедневно. Обновите Bread Codex, чтобы получить самые свежие данные."
