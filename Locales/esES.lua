...
L["empty.no_spec"] = "Elige una especialización para ver tu Bread Codex."
...
L["settings.tooltip.panel_width"] =
    "Anchura del panel de Bread Codex en píxeles. Se aplica a los modos fijo y flotante."
...
L["settings.tooltip.login_message"] =
    "Muestra el mensaje 'Bread Codex cargado. Escribe /cc para abrir' en el chat al iniciar sesión o recargar."
...
L["chat.slash_conflict"] =
    "Otro addon está usando |cff00ccff/cc|r. Escribe |cff00ccff/classcodex|r para abrir Bread Codex."
...
L["settings.tooltip.show_loadout_dock"] =
    "Widget flotante que muestra el nombre de la configuración de talentos activa. Haz clic para cambiar a cualquier configuración guardada de Blizzard o recomendación de Bread Codex."
...
L["settings.label.talent_pane_show"] = "Mostrar Bread Codex en el panel de talentos"
L["settings.tooltip.talent_pane_show"] =
    "Muestra el selector de builds de Bread Codex en el panel de talentos de Blizzard. Desactivar para ocultarlo por completo."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Bread Codex]|r El error '%s' que acabas de ver es un bug conocido de Blizzard. Bread Codex no lo causó. Desactiva 'Añadir Ver talentos al menú clic derecho de unidades' en los ajustes para detenerlo."
...
L["about.discord"] = "Discord de Bread Codex"
...
L["about.settings_tip"] = "Abre todas las opciones de Bread Codex."
L["about.discord_tip"] = "Errores, sugerencias y teorización."
L["about.support_iv_tip"] = "Apoya a Bread Codex haciéndote Premium en Icy Veins."
...
L["settings.tooltip.advanced"] = "Abre la ventana completa de opciones de Bread Codex."
...
L["settings.tooltip.dock_background"] =
    "Color de fondo del dique a opacidad completa. Usa el color de tu clase o un color personalizado. Solo con el tema Bread Codex."
...
L["settings.tooltip.dock_theme"] =
    "Bread Codex añade un fondo degradado, un borde e iconos con anillo. Compacto elimina el fondo y el borde. Minimalista muestra solo la etiqueta."
...
L["item.menu.ah_listed"] = 'Añadido a tu lista de compra "Bread Codex" de Auctionator.'
...
L["onboarding.title"] = "Recorrido de Bread Codex"
L["onboarding.next"] = "Siguiente"
L["onboarding.help_tooltip_title"] = "Recorrido de Bread Codex"
...
L["talent_apply.no_slots_use"] =
    "No hay espacios de configuración libres. Elimina uno para usar las builds de Bread Codex."
...
L["talent_apply.unsaved_changes"] =
    "Tienes cambios de talentos sin guardar. Abre el panel de talentos y haz clic en Aplicar cambios (o haz clic derecho en el nombre de la configuración para descartarlos) antes de aplicar una build de Bread Codex."
L["talent_apply.could_not_load"] =
    "No se pudo cargar la configuración de Bread Codex. Abre el panel de talentos, haz clic en Aplicar cambios y vuelve a intentarlo."
L["talent_apply.name_required"] = "El nombre de la configuración es obligatorio."
L["talent_apply.name_reserved"] = '"%s" está reservado para Bread Codex. Elige otro nombre.'
