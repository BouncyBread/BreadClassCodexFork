...
function ns.RegisterSettings()
    local ok, err = pcall(function()
        ...
        -- Wowhead and Archon default OFF: four sources on every item tooltip is a
        -- wall of text, and the two that shipped first are the established ones.
        check("showWowheadBisTooltip", L["settings.label.wowhead_bis"],
            L["settings.tooltip.wowhead_bis"], false, ns.InvalidateTooltipCache)
        check("showArchonBisTooltip", L["settings.label.archon_bis"],
            L["settings.tooltip.archon_bis"], false, ns.InvalidateTooltipCache)
