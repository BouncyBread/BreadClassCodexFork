  ...
  data = {
    DEATHKNIGHT = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 289, itemId = 249968, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 249973, slot = "Chest" },
              { ilvl = 285, itemId = 237834, slot = "Wrist" },
              { ilvl = 289, itemId = 249971, slot = "Hands" },
              { ilvl = 298, itemId = 268289, slot = "Waist" },
              { ilvl = 289, itemId = 249969, slot = "Legs" },
              { ilvl = 289, itemId = 249381, slot = "Feet" },
              { ilvl = 285, itemId = 240949, slot = "Finger 1" },
      ...
      frost = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 237834, 240949, 237839 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 240952, 237907, 237902, 240951 }, embellishments = {} },
            raid = { crafts = { 239656, 237834, 240949, 237839 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
        ...
        gear = {
          all = {
            mplus = {
              { ilvl = 289, itemId = 249970, slot = "Head" },
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 50234, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 249973, slot = "Chest" },
              { ilvl = 285, itemId = 237834, slot = "Wrist" },
              { ilvl = 289, itemId = 249971, slot = "Hands" },
              { ilvl = 298, itemId = 249967, slot = "Waist" },
              { ilvl = 289, itemId = 249969, slot = "Legs" },
              { ilvl = 289, itemId = 249381, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
            ...
            raid = {
              ...
              { ilvl = 289, itemId = 249969, slot = "Legs" },
              { ilvl = 289, itemId = 249381, slot = "Feet" },
              { ilvl = 289, itemId = 249919, slot = "Finger 1" },
              { ilvl = 285, itemId = 240949, slot = "Finger 2" },
              { ilvl = 298, itemId = 249344, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
        ...
        gems = { all = { all = { { primary = 240983, secondary = { 240908 } } } } },
        statPriority = {
        ...
        statTargets = {
          all = {
            mplus = { crit = 789, haste = 533, mastery = 1206, versatility = 0 },
            raid = { crit = 1085, haste = 265, mastery = 1244, versatility = 0 },
          },
        },
        talents = {
          deathbringer = {
          ...
          ["rider-of-the-apocalypse"] = {
            ...
            ["raid:3181"] = {
              {
                export = "CsPAAAAAAAAAAAAAAAAAAAAAAMAzMjZmZAz2MzMzMbmZMmxYmhZYwMzMzMzMmBAAAAAAAAAwmZzwADMbMMDbYmxMzAzAYAYmZG4BA",
                pickrate = 33.3,
              },
            },
            ["raid:3306"] = {
    ...
    DEMONHUNTER = {
      devourer = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 244576, 237840 }, embellishments = {} },
            ["pvp:3v3"] = {
              crafts = { 244736, 240952, 244556, 239678, 244554, 244740, 244559, 244557, 244558, 244764, 240951 },
              embellishments = {},
            },
            raid = { crafts = { 239656, 237840 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 250030, slot = "Waist" },
              { ilvl = 289, itemId = 49817, slot = "Legs" },
              { ilvl = 289, itemId = 250035, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 249920, slot = "Finger 2" },
              { ilvl = 298, itemId = 249346, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 298, itemId = 260408, slot = "Main Hand" },
              { ilvl = 295, itemId = 237840, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
            ...
            raid = {
              ...
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 289, itemId = 250036, slot = "Chest" },
              { ilvl = 289, itemId = 250029, slot = "Wrist" },
              { ilvl = 289, itemId = 250034, slot = "Hands" },
              { ilvl = 298, itemId = 250030, slot = "Waist" },
              { ilvl = 289, itemId = 49817, slot = "Legs" },
              { ilvl = 289, itemId = 250035, slot = "Feet" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 384, haste = 1113, mastery = 1039, versatility = 0 },
            raid = { crit = 384, haste = 1052, mastery = 1102, versatility = 0 },
          },
        },
        talents = {
          annihilator = {
          ...
          ["void-scarred"] = {
            ...
            ["raid:3182"] = {
              {
                export = "CgcBAAAAAAAAAAAAAAAAAAAAAAAWmZmZmZmZMGmBAAAAAAgxsNYGAAAAAAAAmxMMmZmZMzMzYmtZGjNz2CAAMAzYmZ2mZmZ2mZbmZMjBA",
                pickrate = 100,
              },
            },
            ["raid:3306"] = {
      ...
      havoc = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 244576, 244574, 240949, 237840 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 240952, 244556, 239678, 244554, 244740, 244557, 244764, 240951, 237909 }, embellishments = {} },
            raid = { crafts = { 239656, 244576, 240949, 237840 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 285, itemId = 244574, slot = "Legs" },
              { ilvl = 289, itemId = 250035, slot = "Feet" },
              { ilvl = 285, itemId = 240949, slot = "Finger 1" },
              { ilvl = 289, itemId = 249919, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 268292, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249280, slot = "Main Hand" },
              { ilvl = 295, itemId = 237840, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
            ...
            raid = {
              ...
              { ilvl = 289, itemId = 250034, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
              { ilvl = 289, itemId = 250032, slot = "Legs" },
              { ilvl = 289, itemId = 250035, slot = "Feet" },
              { ilvl = 289, itemId = 249919, slot = "Finger 1" },
              { ilvl = 285, itemId = 240949, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
        ...
        statPriority = {
          ["aldrachi-reaver"] = {
            mplus = {
              minor = { { "Avoidance" }, { "Speed", "Leech" } },
              primary = "Agility",
              secondary = { { "crit" }, { "mastery" }, { "haste", "versatility" } },
            },
            raid = {
              minor = { { "Avoidance" }, { "Speed", "Leech" } },
              primary = "Agility",
        ...
        statTargets = {
          all = {
            mplus = { crit = 1098, haste = 160, mastery = 1247, versatility = 0 },
            raid = { crit = 1017, haste = 271, mastery = 1166, versatility = 54 },
          },
        },
        talents = {
          ["aldrachi-reaver"] = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 268292, slot = "Trinket 2" },
              { ilvl = 295, itemId = 237840, slot = "Main Hand" },
              { ilvl = 295, itemId = 237840, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
              { itemId = 250033, slot = "Head" },
    ...
    DRUID = {
      balance = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250022, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 415, haste = 1119, mastery = 1049, versatility = 37 },
            raid = { crit = 663, haste = 816, mastery = 1104, versatility = 37 },
          },
        },
        talents = {
          ["elunes-chosen"] = {
        ...
        gear = {
          all = {
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 268292, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249302, slot = "Main Hand" },
              { ilvl = 180, itemId = 13353, slot = "Off Hand" },
            },
          },
        },
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 268292, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249278, slot = "Main Hand" },
            },
            ["pvp:3v3"] = {
              { itemId = 250024, slot = "Head" },
        ...
        gear = {
          all = {
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250022, slot = "Shoulders" },
              { ilvl = 289, itemId = 249370, slot = "Back" },
              { ilvl = 289, itemId = 250027, slot = "Chest" },
              { ilvl = 285, itemId = 244576, slot = "Wrist" },
              { ilvl = 289, itemId = 250025, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
              ...
              { ilvl = 289, itemId = 249920, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249809, slot = "Trinket 2" },
              { ilvl = 295, itemId = 245770, slot = "Main Hand" },
              { ilvl = 298, itemId = 249922, slot = "Off Hand" },
            },
          },
    ...
    EVOKER = {
        ...
        gear = {
          all = {
            ...
            ["pvp:3v3"] = {
              ...
              { itemId = 249810, slot = "Trinket 2" },
              { itemId = 249293, slot = "Main Hand" },
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249810, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 295, itemId = 245770, slot = "Main Hand" },
              { ilvl = 298, itemId = 249276, slot = "Off Hand" },
            },
      ...
      devastation = {
        ...
        statTargets = {
          all = {
            mplus = { crit = 938, haste = 920, mastery = 723, versatility = 40 },
            raid = { crit = 938, haste = 920, mastery = 723, versatility = 40 },
          },
        },
        talents = {
          flameshaper = {
        ...
        gear = {
          all = {
            ...
            ["pvp:3v3"] = {
              ...
              { itemId = 255507, slot = "Wrist" },
              { itemId = 249998, slot = "Hands" },
              { itemId = 255504, slot = "Waist" },
              { itemId = 249996, slot = "Legs" },
            ...
            raid = {
              ...
              { ilvl = 285, itemId = 244584, slot = "Wrist" },
              { ilvl = 289, itemId = 249998, slot = "Hands" },
              { ilvl = 289, itemId = 249994, slot = "Waist" },
              { ilvl = 298, itemId = 249996, slot = "Legs" },
    ...
    HUNTER = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 249318, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
      ...
      marksmanship = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 289, itemId = 249986, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 285, itemId = 244609, slot = "Chest" },
        ...
        gems = { all = { all = { { secondary = { 240908, 240967, 240914, 240898, 240890 } } } } },
        statPriority = {
          all = { ["pvp:3v3"] = { secondary = { { "versatility" }, { "mastery" }, { "haste" }, { "crit" } } } },
          ["dark-ranger"] = {
            mplus = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249806, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249925, slot = "Main Hand" },
    ...
    MAGE = {
      arcane = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250058, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 250063, slot = "Chest" },
              { ilvl = 285, itemId = 239648, slot = "Wrist" },
              { ilvl = 289, itemId = 250061, slot = "Hands" },
              { ilvl = 289, itemId = 250057, slot = "Waist" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 662, haste = 702, mastery = 933, versatility = 325 },
            raid = { crit = 672, haste = 702, mastery = 988, versatility = 260 },
          },
        },
        talents = {
          spellslinger = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 285, itemId = 239648, slot = "Wrist" },
              { ilvl = 289, itemId = 250061, slot = "Hands" },
              { ilvl = 285, itemId = 239649, slot = "Waist" },
              { ilvl = 289, itemId = 250059, slot = "Legs" },
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 249346, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249286, slot = "Main Hand" },
              { ilvl = 298, itemId = 249922, slot = "Off Hand" },
            },
          },
        },
      ...
      frost = {
        ...
        statTargets = {
          all = {
            mplus = { crit = 889, haste = 702, mastery = 988, versatility = 43 },
            raid = { crit = 889, haste = 702, mastery = 988, versatility = 43 },
          },
        },
        talents = {
          frostfire = {
            ...
            ["raid:3176"] = {
              {
                export = "62084#80140#1-62087#134199#1-62088#80144#1-62091#80147#1-62094#126060#1-62096#80153#1-62098#80155#1-62100#80157#1-62102#80159#2-62104#80161#1-62105#80163#1-62110#136466#1-62114#80173#2-62115#80174#1-62116#80175#1-62117#80176#1-62122#80181#1-62123#80182#2-62124#80183#1-62127#80187#1-62129#80189#1-62150#134540#1-62151#80214#1-62153#80216#1-62157#80220#1-62163#80226#1-62164#80227#1-62170#80234#1-62176#80241#1-62177#80242#1-62178#80243#1-62179#80244#1-62181#80247#1-62182#80248#1-62184#80250#1-62185#80251#1-81468#102429#1-93524#115877#1-94632#117235#1-94633#117236#1-94634#117237#1-94635#117238#1-94636#117239#1-94637#117240#1-94638#117241#1-94639#117242#1-94640#117243#1-94641#117244#1-94642#117245#1-99828#123342#1-101883#125819#1-103771#134418#1-108653#134180#1-108654#134182#1-108655#134185#1-108657#134187#1-108658#134188#1-108659#134189#1-108660#134190#1-108661#134191#1-108850#136839#1-108852#134408#2-108855#134411#1-108857#134413#1-108858#134414#2-108859#134415#1-108860#134416#1-108864#134421#1-109670#135921#1-109671#135922#1-109672#135923#1-109915#136182#1-110079#136577#1-110081#136579#1-110258#136796#1-110422#137034#1-110422#137033#2-110422#137032#1",
                pickrate = 33.3,
              },
            },
            ["raid:3178"] = {
    ...
    MONK = {
      brewmaster = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250013, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 289, itemId = 250018, slot = "Chest" },
              { ilvl = 289, itemId = 250011, slot = "Wrist" },
              { ilvl = 289, itemId = 250016, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 1114, haste = 333, mastery = 747, versatility = 400 },
            raid = { crit = 1084, haste = 333, mastery = 747, versatility = 432 },
          },
        },
        talents = {
          ["master-of-harmony"] = {
            ...
            ["mplus:61209"] = {
              {
                export = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAgZbzYGGzyMzGzMjBAAAAAAYZBzgZGYGGbAzMzMMb2mZMzywy2DssNbYWAAglZZsMbzsMAAAAG2AzMgxYAAAD",
                pickrate = 17.5,
              },
            },
            raid = {
      ...
      mistweaver = {
        ...
        gear = {
          all = {
            ...
            raid = {
              ...
              { ilvl = 289, itemId = 50228, slot = "Neck" },
              { ilvl = 289, itemId = 250013, slot = "Shoulders" },
              { ilvl = 289, itemId = 250010, slot = "Back" },
              { ilvl = 289, itemId = 250018, slot = "Chest" },
              { ilvl = 285, itemId = 244576, slot = "Wrist" },
              { ilvl = 289, itemId = 250016, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
        ...
        gems = { all = { all = { { primary = 240983, secondary = { 240890 } } } } },
        statPriority = {
          all = { ["pvp:3v3"] = { secondary = { { "haste", "versatility" }, { "crit" }, { "mastery" } } } },
        ...
        statTargets = {
          all = {
            mplus = { crit = 891, haste = 1130, mastery = 350, versatility = 207 },
            raid = { crit = 865, haste = 1232, mastery = 350, versatility = 217 },
          },
        },
        talents = {
          ["conduit-of-the-celestials"] = {
          ...
          ["master-of-harmony"] = {
            ...
            ["raid:3176"] = {
              {
                export = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAghx2MM2sYGzssMjtllZMzmZWWWmZswMmZMDYwAmlZmZGmtBDWMDAAAAY2mZb2mZZ2AAAAYAmZAgxwYZYAA",
                pickrate = 10,
              },
            },
            ["raid:3177"] = {
      ...
      windwalker = {
        ...
        statPriority = {
          ...
          ["conduit-of-the-celestials"] = {
            mplus = {
              minor = { { "Avoidance" }, { "Leech", "Speed" } },
              primary = "Agility",
              secondary = { { "haste" }, { "versatility", "crit", "mastery" } },
            },
            raid = {
              minor = { { "Avoidance" }, { "Leech", "Speed" } },
              primary = "Agility",
              secondary = { { "haste" }, { "crit" }, { "mastery", "versatility" } },
            },
          },
          ["shado-pan"] = {
            mplus = {
        ...
        statTargets = {
          all = {
            mplus = { crit = 774, haste = 866, mastery = 802, versatility = 174 },
            raid = { crit = 861, haste = 866, mastery = 802, versatility = 87 },
          },
        },
        talents = {
          ["conduit-of-the-celestials"] = {
    ...
    PALADIN = {
      holy = {
        ...
        gear = {
          all = {
            mplus = {
              { ilvl = 289, itemId = 249961, slot = "Head" },
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 249959, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 249964, slot = "Chest" },
              { ilvl = 285, itemId = 237834, slot = "Wrist" },
              { ilvl = 289, itemId = 249962, slot = "Hands" },
              { ilvl = 298, itemId = 268289, slot = "Waist" },
            ...
            ["pvp:3v3"] = {
              ...
              { itemId = 255614, slot = "Trinket 1" },
              { itemId = 255616, slot = "Trinket 2" },
              { itemId = 255624, slot = "Main Hand" },
              { itemId = 255632, slot = "Off Hand" },
            },
            raid = {
              { ilvl = 289, itemId = 249961, slot = "Head" },
              { ilvl = 298, itemId = 268291, slot = "Neck" },
        ...
        talents = {
          ...
          lightsmith = {
            ...
            ["raid:3181"] = {
              {
                export = "81496#102465#1-81508#102477#1-81510#133481#1-81554#102533#1-81555#102534#1-81557#102536#1-81558#102537#1-81561#102540#1-81564#102544#1-81565#102545#1-81567#102548#1-81568#102549#1-81569#102550#1-81570#102551#1-81571#102552#1-81573#102556#1-81575#102558#1-81578#102562#1-81580#102564#1-81584#102569#1-81585#102570#1-81588#133501#1-81589#102574#1-81590#102575#1-81591#102577#1-81592#102578#1-81594#102580#1-81597#102583#1-81600#102587#1-81605#102592#1-81608#102596#1-81609#102597#1-81613#102601#1-81614#102602#1-81615#102603#1-81616#102604#1-81621#102612#2-81630#102622#2-81631#128251#1-81632#102625#1-92220#114292#1-93009#115034#2-93180#115465#1-93191#128246#1-93520#115872#1-93521#115873#1-93522#115874#1-93523#115875#1-93927#116376#1-95228#117873#1-95229#117874#1-95230#117875#1-95231#117876#1-95232#117878#1-95233#117881#1-95235#117883#1-95236#117885#1-95237#117886#1-95238#117887#1-99839#123359#1-102502#136574#1-103851#128241#2-103856#128309#1-103858#128254#1-103861#128257#1-103863#128259#1-103864#128260#1-103867#128263#1-103868#128264#1-108034#133407#1-109742#136000#1-109743#136001#1-109744#136002#1-109998#136486#1-109999#136487#1-110012#136503#1-110092#136593#1-110257#136795#1-110417#137019#1-110417#137018#2-110417#137017#1",
                pickrate = 100,
              },
            },
            ["raid:3182"] = {
      ...
      protection = {
        crafting = {
          all = {
            ...
            ["pvp:3v3"] = { crafts = { 237906, 239678, 237902, 240951 }, embellishments = {} },
            raid = { crafts = { 239656, 237834, 237839, 237831 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249342, slot = "Trinket 2" },
              { ilvl = 295, itemId = 237839, slot = "Main Hand" },
              { ilvl = 295, itemId = 237831, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
              { itemId = 255574, slot = "Head" },
              { itemId = 255612, slot = "Neck" },
              { itemId = 237906, slot = "Shoulders" },
              { itemId = 239678, slot = "Back" },
              { itemId = 249964, slot = "Chest" },
              { itemId = 255583, slot = "Wrist" },
              { itemId = 249962, slot = "Hands" },
              { itemId = 255581, slot = "Waist" },
              { itemId = 255578, slot = "Legs" },
              { itemId = 237902, slot = "Feet" },
              { itemId = 255609, slot = "Finger 1" },
      ...
      retribution = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 237834 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 237906, 239678, 244742, 237902, 240951 }, embellishments = {} },
            raid = { crafts = { 239656, 237834, 237831 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
    ...
    PRIEST = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 289, itemId = 250050, slot = "Legs" },
              { ilvl = 298, itemId = 268282, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249808, slot = "Trinket 1" },
      ...
      holy = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250049, slot = "Shoulders" },
              { ilvl = 289, itemId = 250046, slot = "Back" },
              { ilvl = 298, itemId = 250054, slot = "Chest" },
              { ilvl = 285, itemId = 239648, slot = "Wrist" },
              { ilvl = 289, itemId = 250052, slot = "Hands" },
              { ilvl = 285, itemId = 239664, slot = "Waist" },
            ...
            raid = {
              ...
              { ilvl = 289, itemId = 250046, slot = "Back" },
              { ilvl = 298, itemId = 250054, slot = "Chest" },
              { ilvl = 289, itemId = 250047, slot = "Wrist" },
              { ilvl = 289, itemId = 250052, slot = "Hands" },
              { ilvl = 285, itemId = 239664, slot = "Waist" },
              { ilvl = 289, itemId = 250050, slot = "Legs" },
              { ilvl = 298, itemId = 268282, slot = "Feet" },
              { ilvl = 289, itemId = 249336, slot = "Finger 1" },
              { ilvl = 298, itemId = 268290, slot = "Finger 2" },
              { ilvl = 298, itemId = 268292, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 295, itemId = 245770, slot = "Main Hand" },
              { ilvl = 295, itemId = 245769, slot = "Off Hand" },
            },
        ...
        talents = {
          ...
          oracle = {
            ...
            ["raid:3180"] = {
              {
                export = "CEQAAAAAAAAAAAAAAAAAAAAAAADAAAAAAwYMzsMzMjZGDzMGLzMmBAAAwwsMzYmZmhZGzYAzMDAzsghBjZbAGDsYmZAgh5BMGmZAmZmBGA",
                pickrate = 100,
              },
            },
            ["raid:3181"] = {
      ...
      shadow = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 239648 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 239684, 240951, 245870 }, embellishments = {} },
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249346, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249283, slot = "Main Hand" },
              { ilvl = 298, itemId = 249922, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
              { itemId = 250051, slot = "Head" },
              { itemId = 255610, slot = "Neck" },
              { itemId = 255386, slot = "Shoulders" },
              { itemId = 255393, slot = "Back" },
              { itemId = 250054, slot = "Chest" },
              { itemId = 255391, slot = "Wrist" },
              { itemId = 250052, slot = "Hands" },
              { itemId = 255388, slot = "Waist" },
              { itemId = 250050, slot = "Legs" },
              { itemId = 239684, slot = "Feet" },
              { itemId = 240951, slot = "Finger 1" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 361, haste = 1213, mastery = 927, versatility = 36 },
            raid = { crit = 361, haste = 1240, mastery = 984, versatility = 36 },
          },
        },
        talents = {
          archon = {
    ...
    ROGUE = {
      assassination = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250004, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 289, itemId = 250009, slot = "Chest" },
              { ilvl = 285, itemId = 244576, slot = "Wrist" },
              { ilvl = 289, itemId = 250007, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
              { ilvl = 289, itemId = 250005, slot = "Legs" },
              { ilvl = 289, itemId = 250008, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 260235, slot = "Trinket 2" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 901, haste = 714, mastery = 671, versatility = 249 },
            raid = { crit = 1048, haste = 822, mastery = 396, versatility = 249 },
          },
        },
        talents = {
          deathstalker = {
      ...
      outlaw = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 289, itemId = 250009, slot = "Chest" },
              { ilvl = 289, itemId = 50264, slot = "Wrist" },
              { ilvl = 289, itemId = 250007, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
              { ilvl = 289, itemId = 250005, slot = "Legs" },
              { ilvl = 285, itemId = 244569, slot = "Feet" },
            ...
            ["pvp:3v3"] = {
              ...
              { itemId = 255473, slot = "Chest" },
              { itemId = 244740, slot = "Wrist" },
              { itemId = 250007, slot = "Hands" },
              { itemId = 244557, slot = "Waist" },
              { itemId = 250005, slot = "Legs" },
              { itemId = 244553, slot = "Feet" },
              { itemId = 240951, slot = "Finger 1" },
            ...
            raid = {
              ...
              { ilvl = 289, itemId = 50228, slot = "Neck" },
              { ilvl = 289, itemId = 250004, slot = "Shoulders" },
              { ilvl = 289, itemId = 49823, slot = "Back" },
              { ilvl = 289, itemId = 250009, slot = "Chest" },
              { ilvl = 289, itemId = 50264, slot = "Wrist" },
              { ilvl = 289, itemId = 250007, slot = "Hands" },
              { ilvl = 298, itemId = 268286, slot = "Waist" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 1054, haste = 839, mastery = 357, versatility = 264 },
            raid = { crit = 1051, haste = 839, mastery = 357, versatility = 269 },
          },
        },
        talents = {
          fatebound = {
      ...
      subtlety = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 244576, 237837 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 240952, 244560, 244557, 244553, 240951, 237910 }, embellishments = {} },
            raid = { crafts = { 239656, 244576, 237837 }, embellishments = {} },
          },
        },
        enchants = {
        ...
        gear = {
          all = {
            mplus = {
              { ilvl = 298, itemId = 250006, slot = "Head" },
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250004, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 289, itemId = 250009, slot = "Chest" },
        ...
        statTargets = {
          all = {
            mplus = { crit = 452, haste = 478, mastery = 1387, versatility = 218 },
            raid = { crit = 452, haste = 478, mastery = 1387, versatility = 218 },
          },
        },
        talents = {
          deathstalker = {
            ...
            ["raid:3180"] = {
              {
                export = "CUQAAAAAAAAAAAAAAAAAAAAAAAgx2MAAAAAwsMGLzwstNGzMmBzMzMjxsNMDLzMzMzMjBjZ2GAAAAzgxsYWGYALglhZAzCmhZGgZ8AA",
                pickrate = 100,
              },
            },
            ["raid:3181"] = {
    ...
    SHAMAN = {
      elemental = {
        ...
        gear = {
          all = {
            mplus = {
              { ilvl = 289, itemId = 249979, slot = "Head" },
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 249977, slot = "Shoulders" },
              { ilvl = 289, itemId = 249974, slot = "Back" },
              { ilvl = 289, itemId = 249982, slot = "Chest" },
              { ilvl = 285, itemId = 244584, slot = "Wrist" },
        ...
        talents = {
          farseer = {
            ...
            ["raid:3179"] = {
              {
                export = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMLbzMmZmZZZZwMMAAAAgFzsBDYAzGzAmFAY2mZmxMbLmZhZsNWmZmZMsZZYxMzMzsBAMMAmZMM8AA",
                pickrate = 36,
              },
            },
            ["raid:3180"] = {
      ...
      enhancement = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 244584, 237850 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 244568, 244566, 244765, 240951 }, embellishments = {} },
            raid = { crafts = { 239656, 244584, 237850 }, embellishments = {} },
          },
        },
        enchants = {
          all = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 285, itemId = 244584, slot = "Wrist" },
              { ilvl = 289, itemId = 249980, slot = "Hands" },
              { ilvl = 289, itemId = 249976, slot = "Waist" },
              { ilvl = 298, itemId = 268288, slot = "Legs" },
              { ilvl = 298, itemId = 268287, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 249920, slot = "Finger 2" },
              ...
              { ilvl = 295, itemId = 237850, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
              { itemId = 249979, slot = "Head" },
              { itemId = 255610, slot = "Neck" },
              { itemId = 255540, slot = "Shoulders" },
              { itemId = 255547, slot = "Back" },
              { itemId = 249982, slot = "Chest" },
              { itemId = 244568, slot = "Wrist" },
              { itemId = 255535, slot = "Hands" },
              { itemId = 255542, slot = "Waist" },
              { itemId = 244566, slot = "Legs" },
              { itemId = 244765, slot = "Feet" },
              { itemId = 240951, slot = "Finger 1" },
      ...
      restoration = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249808, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249293, slot = "Main Hand" },
              { ilvl = 298, itemId = 249275, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
              ...
              { itemId = 249980, slot = "Hands" },
              { itemId = 244565, slot = "Waist" },
              { itemId = 249978, slot = "Legs" },
              { itemId = 255533, slot = "Feet" },
              { itemId = 240951, slot = "Finger 1" },
              { itemId = 240951, slot = "Finger 2" },
              { itemId = 255614, slot = "Trinket 1" },
              { itemId = 255616, slot = "Trinket 2" },
        ...
        talents = {
          farseer = {
            ...
            ["mplus:12805"] = {
              {
                export = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAgBAAAAzMzsssNmZmZMzYMjxiZWgBMgZhZAjFzMzgZbmxYmllZGmxsxiZmZMsMLDAAAwMAYmBG8AA",
                pickrate = 100,
              },
            },
            ["mplus:12811"] = {
      ...
      affliction = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 268291, slot = "Neck" },
              { ilvl = 289, itemId = 250040, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 250045, slot = "Chest" },
              { ilvl = 285, itemId = 239648, slot = "Wrist" },
              { ilvl = 289, itemId = 250043, slot = "Hands" },
              { ilvl = 289, itemId = 250039, slot = "Waist" },
            ...
            ["pvp:3v3"] = {
              ...
              { itemId = 255610, slot = "Neck" },
              { itemId = 250040, slot = "Shoulders" },
              { itemId = 255413, slot = "Back" },
              { itemId = 250045, slot = "Chest" },
              { itemId = 255411, slot = "Wrist" },
              { itemId = 255399, slot = "Hands" },
              { itemId = 255408, slot = "Waist" },
              { itemId = 255404, slot = "Legs" },
              { itemId = 239684, slot = "Feet" },
              { itemId = 240951, slot = "Finger 1" },
              { itemId = 240951, slot = "Finger 2" },
              { itemId = 255614, slot = "Trinket 1" },
        ...
        statPriority = {
          ...
          hellcaller = {
            mplus = {
              minor = { { "Speed", "Avoidance", "Leech" } },
              primary = "Intellect",
              secondary = { { "haste" }, { "crit" }, { "versatility", "mastery" } },
            },
            raid = {
              minor = { { "Avoidance", "Speed", "Leech" } },
              primary = "Intellect",
        ...
        talents = {
          hellcaller = {
            ...
            ["mplus:12805"] = {
              {
                export = "CkQAAAAAAAAAAAAAAAAAAAAAAsZGmZMzmZsNzMzsNAAgZmZxiZmlxAAWgBmFjZMDgZDsMAAAMDAAMzgxMGz2MjZMzMzMMMzMDAwAeA",
                pickrate = 100,
              },
            },
            ["mplus:12915"] = {
      ...
      demonology = {
        ...
        gear = {
          all = {
            ...
            ["pvp:3v3"] = {
              { itemId = 250042, slot = "Head" },
              { itemId = 50228, slot = "Neck" },
              { itemId = 239650, slot = "Shoulders" },
              { itemId = 239656, slot = "Back" },
              { itemId = 250045, slot = "Chest" },
    ...
    WARRIOR = {
      arms = {
        crafting = {
          all = {
            mplus = { crafts = { 239656, 237834 }, embellishments = {} },
            ["pvp:3v3"] = { crafts = { 244738, 239678, 237908 }, embellishments = {} },
            raid = { crafts = { 239656, 237834 }, embellishments = {} },
          },
        },
        enchants = {
        ...
        gear = {
          all = {
            mplus = {
              { ilvl = 289, itemId = 249952, slot = "Head" },
              { ilvl = 289, itemId = 50228, slot = "Neck" },
              { ilvl = 289, itemId = 249950, slot = "Shoulders" },
              { ilvl = 285, itemId = 239656, slot = "Back" },
              { ilvl = 298, itemId = 249955, slot = "Chest" },
              { ilvl = 285, itemId = 237834, slot = "Wrist" },
              { ilvl = 289, itemId = 249953, slot = "Hands" },
              { ilvl = 298, itemId = 249949, slot = "Waist" },
              { ilvl = 289, itemId = 249951, slot = "Legs" },
              { ilvl = 289, itemId = 249954, slot = "Feet" },
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249342, slot = "Trinket 2" },
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 268290, slot = "Finger 1" },
              { ilvl = 289, itemId = 49812, slot = "Finger 2" },
              { ilvl = 298, itemId = 249342, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249343, slot = "Trinket 2" },
              { ilvl = 298, itemId = 49802, slot = "Main Hand" },
            },
          },
        ...
        statTargets = {
          all = {
            mplus = { crit = 944, haste = 1115, mastery = 423, versatility = 36 },
            raid = { crit = 944, haste = 1115, mastery = 423, versatility = 36 },
          },
        },
        talents = {
          colossus = {
      ...
      fury = {
        ...
        gear = {
          all = {
            mplus = {
              ...
              { ilvl = 298, itemId = 249342, slot = "Trinket 2" },
              { ilvl = 298, itemId = 49802, slot = "Main Hand" },
              { ilvl = 295, itemId = 237846, slot = "Off Hand" },
            },
            ["pvp:3v3"] = {
        ...
        statTargets = {
          all = {
            mplus = { crit = 458, haste = 1225, mastery = 990, versatility = 36 },
            raid = { crit = 397, haste = 1165, mastery = 1111, versatility = 36 },
          },
        },
        talents = {
          ["mountain-thane"] = {
      ...
      protection = {
        ...
        gear = {
          all = {
            ...
            raid = {
              ...
              { ilvl = 298, itemId = 249343, slot = "Trinket 1" },
              { ilvl = 298, itemId = 249342, slot = "Trinket 2" },
              { ilvl = 298, itemId = 249295, slot = "Main Hand" },
              { ilvl = 298, itemId = 249275, slot = "Off Hand" },
            },
          },
        },
        ...
        statTargets = {
          all = {
            mplus = { crit = 550, haste = 1134, mastery = 698, versatility = 210 },
            raid = { crit = 428, haste = 1255, mastery = 698, versatility = 186 },
          },
        },
        talents = {
          colossus = {
